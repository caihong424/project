 ...
 * 
 * @author 王畅
 * @version 创建时间：2015-4-30 上午10:02:33
 */
public class ObjectSortUtil {
	...
	public static class MapSort {
		 ...
		 *            (ASC升序 DESC降序)
		 */
		public static List<Map.Entry<String, String>> sortMapByKey(Map<String, String> map, final String sortMode) throws Exception {
			if (map == null)
				return null;
			...
			Collections.sort(list, new Comparator<Map.Entry<String, String>>() {
				public int compare(Map.Entry<String, String> o1, Map.Entry<String, String> o2) {
					boolean ASC_order = (sortMode == null || "ASC".equalsIgnoreCase(sortMode));
					return ASC_order ? (o1.getKey()).toString().compareTo(o2.getKey()) : (o2.getKey()).toString().compareTo(o1.getKey());
				}
			});
			return list;
		}
		 ...
		 *            (ASC升序 DESC降序)
		 */
		public static List<Map.Entry<String, String>> sortMapByValue(Map<String, String> map, final String sortMode) throws Exception {
			if (map == null)
				return null;
			List<Map.Entry<String, String>> list = new ArrayList<Map.Entry<String, String>>(map.entrySet());
			if (list == null)
			...
			Collections.sort(list, new Comparator<Map.Entry<String, String>>() {
				public int compare(Map.Entry<String, String> o1, Map.Entry<String, String> o2) {
					boolean ASC_order = (sortMode == null || "ASC".equalsIgnoreCase(sortMode));
					return ASC_order ? (o1.getValue()).toString().compareTo(o2.getValue()) : (o2.getValue()).toString().compareTo(o1.getValue());
				}
			});
			return list;
		}
